...
function _processUpdateFromFirebase(snap, ctx) {
    ...
    let data = value[DB_CONST.DATA_KEY];
...
export { forceSignOut, forceSignIn, initAuth, dispatchActionAndSaveStateToFirebase };
